            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" aria-current="page" href="<?=$_SERVER['PHP_SELF']?>?cmd=1"> alpha vantage</a>
                    </li>
                    <li class="nav-item">
                        <!-- Построю ссылку на себя, и передам переменную GET с именем cmd равную 1 -->
                        <a class="nav-link" aria-current="page" href="<?=$_SERVER['PHP_SELF']?>?cmd=2"> Img vantage</a>
                    </li>
                </ul>
            </div>
        </div>
