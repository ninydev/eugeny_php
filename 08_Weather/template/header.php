            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" aria-current="page" href="<?=$_SERVER['PHP_SELF']?>?cmd=1"> JS Request </a>
                    </li>
                    <li class="nav-item">
                        <!-- Построю ссылку на себя, и передам переменную GET с именем cmd равную 1 -->
                        <a class="nav-link" aria-current="page" href="<?=$_SERVER['PHP_SELF']?>?cmd=2"> curl Request </a>
                    </li>
                    <li class="nav-item">
                        <!-- Построю ссылку на себя, и передам переменную GET с именем cmd равную 1 -->
                        <a class="nav-link" aria-current="page" href="<?=$_SERVER['PHP_SELF']?>?cmd=3"> put Cities to DB </a>
                    </li>
                    <li class="nav-item">
                        <!-- Построю ссылку на себя, и передам переменную GET с именем cmd равную 1 -->
                        <a class="nav-link" aria-current="page" href="<?=$_SERVER['PHP_SELF']?>?cmd=5"> Get City Id from DB </a>
                    </li>
                </ul>
            </div>
        </div>
