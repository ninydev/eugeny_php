...
<script>
    ...
    function doSendToMyServer() {
        ...
        fetch( // Отправка запроса
            "http://localhost:63342/eugeny_php/05_novaposhta/api/saveCities.php?test=1111", // url куда
        ...
        body: JSON.stringify( // данные (тело), которые я передаю сайту
            {
                ...
                modelName: "Address", // Указывает серверу, какой контроллер и модель использовать
                calledMethod: "getCities", // Указывает на номер операции, которую нужно запустить
                methodProperties: { // перечень параметров для выбранной операции
                    // Ref: "ebc0eda9-93ec-11e3-b441-0050568002cf" // найдет конкретно город
